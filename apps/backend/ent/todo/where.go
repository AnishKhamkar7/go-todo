...
func TypesIsNil() predicate.Todo {
	return predicate.Todo(sql.FieldIsNull(FieldTypes))
}

// TypesNotNil applies the NotNil predicate on the "types" field.
func TypesNotNil() predicate.Todo {
	return predicate.Todo(sql.FieldNotNull(FieldTypes))
}
