...
import (
	...
	"github.com/AnishKhamkar7/todo-api/ent/predicate"
...
func (tu *TodoUpdate) SetTypes(s []string) *TodoUpdate {
	tu.mutation.SetTypes(s)
	return tu
}

// AppendTypes appends s to the "types" field.
func (tu *TodoUpdate) AppendTypes(s []string) *TodoUpdate {
	tu.mutation.AppendTypes(s)
	return tu
}

// ClearTypes clears the value of the "types" field.
func (tu *TodoUpdate) ClearTypes() *TodoUpdate {
	tu.mutation.ClearTypes()
	return tu
}
...
func (tu *TodoUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tu.mutation.Types(); ok {
		_spec.SetField(todo.FieldTypes, field.TypeJSON, value)
	}
	if value, ok := tu.mutation.AppendedTypes(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, todo.FieldTypes, value)
		})
	}
	if tu.mutation.TypesCleared() {
		_spec.ClearField(todo.FieldTypes, field.TypeJSON)
	}
...
// SetTypes sets the "types" field.
func (tuo *TodoUpdateOne) SetTypes(s []string) *TodoUpdateOne {
	tuo.mutation.SetTypes(s)
	return tuo
}

// AppendTypes appends s to the "types" field.
func (tuo *TodoUpdateOne) AppendTypes(s []string) *TodoUpdateOne {
	tuo.mutation.AppendTypes(s)
	return tuo
}

// ClearTypes clears the value of the "types" field.
func (tuo *TodoUpdateOne) ClearTypes() *TodoUpdateOne {
	tuo.mutation.ClearTypes()
	return tuo
}
...
func (tuo *TodoUpdateOne) sqlSave(ctx context.Context) (_node *Todo, err error) {
	...
	if value, ok := tuo.mutation.Types(); ok {
		_spec.SetField(todo.FieldTypes, field.TypeJSON, value)
	}
	if value, ok := tuo.mutation.AppendedTypes(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, todo.FieldTypes, value)
		})
	}
	if tuo.mutation.TypesCleared() {
		_spec.ClearField(todo.FieldTypes, field.TypeJSON)
	}
