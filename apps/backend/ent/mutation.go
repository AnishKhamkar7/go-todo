...
func (m *TodoMutation) SetTypes(s []string) {
	m.types = &s
	m.appendtypes = nil
}

// Types returns the value of the "types" field in the mutation.
func (m *TodoMutation) Types() (r []string, exists bool) {
	v := m.types
	if v == nil {
		return
	}
...
// OldTypes returns the old "types" field's value of the Todo entity.
// If the Todo object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TodoMutation) OldTypes(ctx context.Context) (v []string, err error) {
...
func (m *TodoMutation) AppendTypes(s []string) {
...
func (m *TodoMutation) AppendedTypes() ([]string, bool) {
...
func (m *TodoMutation) ClearTypes() {
	m.types = nil
	m.appendtypes = nil
	m.clearedFields[todo.FieldTypes] = struct{}{}
}

// TypesCleared returns if the "types" field was cleared in this mutation.
func (m *TodoMutation) TypesCleared() bool {
	_, ok := m.clearedFields[todo.FieldTypes]
	return ok
}

// ResetTypes resets all changes to the "types" field.
func (m *TodoMutation) ResetTypes() {
	m.types = nil
	m.appendtypes = nil
	delete(m.clearedFields, todo.FieldTypes)
}
...
func (m *TodoMutation) Fields() []string {
	...
	if m.types != nil {
		fields = append(fields, todo.FieldTypes)
	}
	if m.title != nil {
...
func (m *TodoMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(todo.FieldTypes) {
		fields = append(fields, todo.FieldTypes)
	}
	return fields
}
